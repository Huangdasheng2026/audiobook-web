  ...
  async _loadLibs(forceReload = false) {
    const libs = [
      { name: 'pdfjsLib', urls: [
        ...
        'https://unpkg.com/pdfjs-dist@4.9.155/build/pdf.min.mjs',
        'https://cdn.bootcdn.net/ajax/libs/pdf.js/3.11.174/pdf.min.js',
        'https://cdn.bootcdn.net/ajax/libs/pdf.js/4.9.155/pdf.min.mjs',
        'https://lib.baomitu.com/pdf.js/3.11.174/pdf.min.js',
